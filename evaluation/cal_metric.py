...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt_dir', type=str, default='/data/huyb/nips-2023/NeuRIS-Object/test', help='gt data')
    ...
    for scene_name in ['scene0008_00', 'scene0005_00', 'scene0050_00', 'scene0461_00', 'scene0549_00', 'scene0616_00']:
        ...
        file = open(os.path.join(args.vis_out_dir, f"metric_{scene_name}.txt"), 'w')
